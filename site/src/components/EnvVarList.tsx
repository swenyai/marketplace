      ...
      {optional.length > 0 && (
        <>
          <button
            ...
            className="w-full text-left text-[12px] text-text-muted hover:text-text transition py-2 px-3 border border-dashed border-border rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent min-h-[44px] md:min-h-[36px] flex items-center"
          >
            {showOptional
              ? `Hide optional (${optional.length}) ⌃`
...
function renderVar(v: DerivedVariable) {
  return (
